...
stopwords = open('stopwords', encoding = 'utf8') # SAGU: added to open the stopwords file
...
## SAGU: added to iterate through the stopwords file and list them. Finally list l is assigned to stopwords variable.
l = []
for w in stopwords.read().lower().split():
    l.append(w) 
stopwords = l
